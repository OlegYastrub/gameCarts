...
public class CartsMiddleRight : MonoBehaviour
{
    ...
    public Vector3[] beginPosition1 = new Vector3[4];
    public Vector3[] beginPosition2 = new Vector3[4];
    public Vector3[] beginPosition3 = new Vector3[4];
    public Vector3[] beginPosition4 = new Vector3[4];
    public Vector3[] beginPosition5 = new Vector3[4];
    public Vector3[] beginPosition6 = new Vector3[4];
    public Vector3[] beginPosition7 = new Vector3[4];
    public Vector3[] beginPosition8 = new Vector3[4];
    public Vector3[] beginPosition9 = new Vector3[4];
    ...
    void Start()
    {
        for (int i = 0; i < 9; i++)
        {
            for (int j = 0; j < 4; j++)
            {
                switch (i)
                {
                    case 0: { beginPosition1[j] = cartsMiddle1[j].transform.position; break; }
                    case 1: { beginPosition2[j] = cartsMiddle2[j].transform.position; break; }
                    case 2: { beginPosition3[j] = cartsMiddle3[j].transform.position; break; }
                    case 3: { beginPosition4[j] = cartsMiddle4[j].transform.position; break; }
                    case 4: { beginPosition5[j] = cartsMiddle5[j].transform.position; break; }
                    case 5: { beginPosition6[j] = cartsMiddle6[j].transform.position; break; }
                    case 6: { beginPosition7[j] = cartsMiddle7[j].transform.position; break; }
                    case 7: { beginPosition8[j] = cartsMiddle8[j].transform.position; break; }
                    case 8: { beginPosition9[j] = cartsMiddle9[j].transform.position; break; }
                }
            }
        }
    }
    ...
    public void BackPosition()
    {
        for (int i = 0; i < 9; i++)
        {
            for (int j = 0; j < 4; j++)
            {
                switch (i)
                {
                    case 0: { cartsMiddle1[j].transform.position = beginPosition1[j]; break; }
                    case 1: { cartsMiddle2[j].transform.position = beginPosition2[j]; break; }
                    case 2: { cartsMiddle3[j].transform.position = beginPosition3[j]; break; }
                    case 3: { cartsMiddle4[j].transform.position = beginPosition4[j]; break; }
                    case 4: { cartsMiddle5[j].transform.position = beginPosition5[j]; break; }
                    case 5: { cartsMiddle6[j].transform.position = beginPosition6[j]; break; }
                    case 6: { cartsMiddle7[j].transform.position = beginPosition7[j]; break; }
                    case 7: { cartsMiddle8[j].transform.position = beginPosition8[j]; break; }
                    case 8: { cartsMiddle9[j].transform.position = beginPosition9[j]; break; }
                }
            }
        }
    }
