...
public class AnalyzGame : MonoBehaviour, IPointerDownHandler
{
    public GameObject cartsMiddle; //playerinfo
    public GameObject queues; //playerinfo
    public GameObject cartsRightToMiddle; //playerinfo
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        LoadCarts();
        UpCarts();
        cartsRightToMiddle.SetActive(true);
        backToGame.SetActive(true);
        exampleGame.SetActive(true);

        scoresEnd.SetActive(false);
